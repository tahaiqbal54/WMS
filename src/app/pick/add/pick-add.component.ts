...
import { ReceiveService, AllocationService ,ExcelService} from '../../_services';
...
export class PickAddComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(private router: Router,private excelService:ExcelService, private AllocationService: AllocationService, private orderservice: OrderService, private receiveservice: ReceiveService, private route: ActivatedRoute, private toastyService: ToastyService, private toastCommunicationService: NotificationCommunicationService) {
