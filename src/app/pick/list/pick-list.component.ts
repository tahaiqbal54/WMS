...
import {ReceiveService,AllocationService,PickService} from '../../_services';
...
export class PickListComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(private router: Router,private PickService: PickService,private receiveservice: ReceiveService, private route: ActivatedRoute,private AllocationService: AllocationService) {
  ...
  ngOnInit() {
    ...
    this.PickService.getPick(this.user_id)
      .subscribe(
        (data: any) => {
          console.log(data);
