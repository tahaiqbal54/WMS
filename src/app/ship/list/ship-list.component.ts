...
import {ReceiveService,AllocationService,PickService,ShipService} from '../../_services';
...
export class ShipListComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(private router: Router,private ShipService: ShipService,private receiveservice: ReceiveService, private route: ActivatedRoute,private AllocationService: AllocationService) {
  ...
  ngOnInit() {
    ...
    this.ShipService.getShips(this.user_id)
      .subscribe(
        (data: any) => {
          console.log(data);
