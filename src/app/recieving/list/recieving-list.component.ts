...
@Component({
  templateUrl: 'recieving-list.html',
  providers: [ReceiveService]
})
export class RecievingListComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(private router: Router,private receiveservice: ReceiveService, private route: ActivatedRoute) {
