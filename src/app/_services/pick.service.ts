...
export class PickService {
  ...
  getPick(user_id: string) {
    ...
    return this.http
      .get(this.APIConfig.getUrl(this.API.GET_PICKS, "UserId="+ user_id), httpOptions)
      .pipe((data: any) => {
        if (data) {
          return data;
        }
  ...
  getPickDetails(SONo: string) {
    ...
    return this.http
      .get(this.APIConfig.getUrl(this.API.GET_PICK_SONO, "SONo="+ SONo), httpOptions)
      .pipe((data: any) => {
        if (data) {
          return data;
        }
