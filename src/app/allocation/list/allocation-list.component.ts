...
export class AllocationListComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(private router: Router,private receiveservice: ReceiveService, private route: ActivatedRoute,private AllocationService: AllocationService) {
  ...
  ngOnInit() {
    ...
    this.AllocationService.getAllocation(this.user_id)
      .subscribe(
        (data: any) => {
          console.log(data);
